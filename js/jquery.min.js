...
/*! Bootstrap v4.1.0 (https://getbootstrap.com/) Copyright 2011-2018 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors) */
...
jQuery(document).ready(function( $ ){ 
	...
	$(".close_button").show(); 	
	$(".open_button").hide();														                   
	$(".close-reasons").slideDown(1000); 			  
  
});
	$(".close_button").click(function(){
	$(".close-reasons").slideUp(500);
	$(".open_button").show();														                   
	$(".close_button").hide(); 	
